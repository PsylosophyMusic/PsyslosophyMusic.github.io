...
The Feedback Oscillator sits somewhere between a traditional sound source and a reactive sound system. It is not a classic VCO (see: (../../Glossary/Oscillator.md)) in the usual sense, but rather an oscillator that continuously listens to itself.
